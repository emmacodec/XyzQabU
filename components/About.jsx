    ...
    <div id='about' className='w-full md:h-screen p-2 flex items-center py-16'>
      ...
      <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
        ...
        <div className='col-span-2'>
            <p className='uppercase tracking-widest text-xl text-[#5651e5] font-bold'>About</p>
            <h2 className='py-4 font-bold'>Who I Am</h2>
            <p className='py-2 text-gray-600'>I'm not your regular developer</p>
            <p className='text-gray-600 py-2'>I've spent the last 6 years as a professional laboratory technician ans a quality control analyst or officer.
